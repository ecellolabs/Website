...
const translations: Record<Language, Translations> = {
  en: {
    ...
    footer: {
      ...
      pageLabels: ["Home", "About Us", "Case Studies", "Contact Us", "Book Meeting"],
      legalLabels: ["Privacy Policy", "Cookie Consent", "Terms & Conditions"],
      newsletter: "Start a Conversation",
      newsletterDesc: "Need help with a product, automation, AI, or cloud project? Reach out and we will point you to the right next step.",
  ...
  de: {
    ...
    footer: {
      ...
      pageLabels: ["Startseite", "Über uns", "Fallstudien", "Kontakt", "Termin buchen"],
      legalLabels: ["Datenschutz", "Cookie-Einwilligung", "AGB"],
      newsletter: "Gespräch Starten",
      newsletterDesc: "Brauchen Sie Hilfe bei einem Produkt-, Automatisierungs-, KI- oder Cloud-Projekt? Schreiben Sie uns, und wir zeigen Ihnen den richtigen nächsten Schritt.",
      emailPlaceholder: "sie@unternehmen.de",
      subscribe: "Kontaktieren Sie Uns",
  ...
  fr: {
    ...
    footer: {
      ...
      pageLabels: ["Accueil", "À propos", "Études de cas", "Contact", "Réserver"],
      legalLabels: ["Politique de confidentialité", "Consentement aux cookies", "Conditions générales"],
      newsletter: "Démarrer La Conversation",
      newsletterDesc: "Besoin d'aide sur un projet produit, automatisation, IA ou cloud ? Contactez-nous et nous vous orienterons vers la bonne prochaine étape.",
