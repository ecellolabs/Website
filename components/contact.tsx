...
const contactInfo = [
  ...
  },
  {
    id: 4,
    label: "LinkedIn",
    value: "linkedin.com/company/ecello",
    icon: (
...
export default function Contact() {
  ...
  return (
    <section id="contact-us" className="py-24 px-4 md:px-6 lg:px-8">
      ...
      <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-foreground/80 mb-10">
            We're here to help you with any questions and services.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            {contactInfo.map((info) => (
              <div
                key={info.id}
                className="flex items-start gap-4 p-6 rounded-2xl bg-white border border-gray-200 hover:border-black transition-colors duration-300"
              >
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-black text-white px-6 py-3 rounded-full transition-all duration-300 font-medium cursor-pointer"
              >
                Send Us An Email
              </button>
            </form>
